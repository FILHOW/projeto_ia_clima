...
page = st.sidebar.radio(
    ...
    index=0,
    help="Escolha entre a tela principal e o chatbot."
)
...
if page == "Página Principal":
    ...
    st.info("""
        **Sobre as Métricas:**
        ...
        - **MSE (Erro Quadrático Médio):** Média dos quadrados das diferenças entre valores previstos e reais.
        - **RMSE (Raiz do Erro Quadrático Médio):** Raiz quadrada do MSE, facilita interpretação na mesma escala dos dados.
        - **R² (Coeficiente de Determinação):** Mede o quanto o modelo explica da variação dos dados (1 = perfeito).
        
        **Tipo de Regressão Utilizada:**
        - O modelo utiliza **Regressão Linear** para prever a precipitação a partir das variáveis disponíveis.
    """)
    ...
    if st.sidebar.button('2. Treinar o Modelo', help='Treina um modelo de Regressão Linear com os dados da tabela SPEC.', key='train_model'):
        with st.spinner('Treinando o modelo...'):
            ...
            if sucesso:
                ...
                st.markdown("""
                    **Sobre a Tabela de Coeficientes:**
                    - Cada linha representa uma variável utilizada pelo modelo de Regressão Linear.
                    - O valor do coeficiente indica o quanto aquela variável influencia a previsão da precipitação.
                    - Coeficientes positivos aumentam a previsão, negativos diminuem.
                    - Quanto maior o valor absoluto do coeficiente, maior a influência da variável na previsão.
                """)
    ...
    st.title("🤖 Chatbot de Análise do Modelo de Clima")
    st.markdown("""
        Pergunte sobre variáveis importantes, métricas do modelo, pipeline ou privacidade dos dados.
        Exemplos: 'Quais variáveis mais importam?', 'Quais as métricas do modelo?', 'Como funciona o pipeline?'
    """)
